    ...
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Button 
              variant="outline" 
              onClick={() => handleFabAction('quickAction', { action: 'refresh', page: 'profile-sessions' })}
            >
              Refresh
            </Button>
            <Button 
              variant="default"
              onClick={() => handleFabAction('assistant', 'Help me with Active Sessions')}
            >
              AI Assistant
            </Button>
          </div>
        ...
        <p className="text-gray-600">
          Current sessions, device management, session control
        </p>
      </div>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Current sessions, device management, session control</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="text-center py-8">
                ...
                <div className="mt-4 flex flex-wrap justify-center gap-2">
                  <Badge variant="outline">Current Sessions</Badge>
              ...
              <div className="border-t pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Button 
                    ...
                    onClick={() => handleFabAction('dispatch', { type: 'profile-sessions_action', payload: { action: 'configure' } })}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="h-20 flex flex-col items-center justify-center"
                    onClick={() => handleFabAction('assistant', 'Help me understand Active Sessions')}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    className="h-20 flex flex-col items-center justify-center"
                    onClick={() => handleFabAction('quickAction', { action: 'export', page: 'profile-sessions' })}
                  >
