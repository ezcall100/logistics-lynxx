    ...
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-600">
          CPU, memory, disk, network performance tracking
        </p>
      </div>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>CPU, memory, disk, network performance tracking</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 space-y-2 flex flex-wrap justify-center gap-2">
                <Badge variant="outline">Server Metrics</Badge>
                <Badge variant="outline">Resource Monitoring</Badge>
                <Badge variant="outline">Performance Alerts</Badge>
              </div>
