...
import { Plus, Building, DollarSign, Users } from 'lucide-react';
      ...
      <div className="container-responsive space-y-6 animate-fade-in">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">Manage vendor relationships and payments</p>
          </div>
          <Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">New vendor partnerships</p>
            </CardContent>
          </Card>
        </div>
