      ...
      <div className="container-responsive space-y-6 animate-fade-in">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Review and approve expense reports</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-muted-foreground">Expense report management interface will be implemented here</p>
          </CardContent>
        </Card>
      </div>
    </Layout>
