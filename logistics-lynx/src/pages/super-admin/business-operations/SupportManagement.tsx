    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Support ticket system, customer service, helpdesk</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 space-y-2">
                <Badge variant="outline">Ticket System</Badge>
                <Badge variant="outline">Customer Service</Badge>
                <Badge variant="outline">Helpdesk Management</Badge>
              </div>
