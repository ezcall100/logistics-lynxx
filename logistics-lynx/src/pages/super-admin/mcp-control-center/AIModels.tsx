    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Model training, deployment, performance monitoring
        </p>
      </div>
      ...
      <ResponsiveCard>
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">AI Models</h3>
          <p className="text-slate-600 dark:text-slate-400">Model training, deployment, performance monitoring</p>
        </div>
        <div>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 space-y-2">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400">Model Training</span>
