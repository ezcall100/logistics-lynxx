...
import { X, Save, Users, Settings, Lock, UserPlus, Trash2 } from 'lucide-react';
...
const EditGroupForm: React.FC<EditGroupFormProps> = ({ groupId, onSave, onCancel, onDelete }) => {
  ...
  const mockGroupData: GroupData = {
    ...
    description: 'Core development team members working on product features',
    memberCount: 15,
    maxMembers: 20,
    status: 'active',
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-3xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-blue-600 dark:text-blue-400">Group ID: {formData.id}</p>
                <p className="text-sm text-blue-600 dark:text-blue-400">
                  Current Members: {formData.memberCount} / {formData.maxMembers}
                </p>
              </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Are you sure you want to delete group "{formData.name}"? This action cannot be undone.
              </p>
