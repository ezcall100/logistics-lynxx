...
import { X, Save, Shield, Users, Settings } from 'lucide-react';
...
const AddRoleForm: React.FC<AddRoleFormProps> = ({ onSave, onCancel }) => {
  const [formData, setFormData] = useState<Omit<RoleData, 'id' | 'userCount' | 'createdAt' | 'updatedAt' | 'createdBy'>>({
    name: '',
    description: '',
    permissions: [],
    priority: 4,
