...
const PortalCompliance: React.FC<PortalComplianceProps> = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <ResponsiveCard>
        <div className="mb-4">
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-100">Portal Compliance</h3>
          <p className="text-slate-600 dark:text-slate-400">Portal-specific compliance requirements, audit trails</p>
        </div>
        <div>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 space-y-2">
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-400">Portal Compliance</span>
              ...
              <EnhancedButton className="mt-6">
                Configure Portal Compliance</EnhancedButton>
            </div>
          )}
        </div>
      </ResponsiveCard>
