...
import { AllAgentsActive } from '@/components/autonomous/AllAgentsActive';
      ...
      <div className="w-full max-w-4xl mx-auto pt-8 px-4">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-green-200">
          <div className="p-6">
               ...
               <h2 className="text-xl font-bold text-purple-800">🤖 ALL AUTONOMOUS AGENTS CONTROL CENTER</h2>
             </div>
             <AllAgentsActive />
          </div>
        </div>
