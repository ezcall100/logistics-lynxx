      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Latest updates and improvements to the Trans Bot AI platform.
          </p>
        </div>
       ...
       <div className="text-center">
         <h3 className="text-2xl font-bold text-gray-900 mb-4">Latest updates and improvements to the Trans Bot AI platform.</h3>
