    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Stay informed on DOT and industry regulation changes</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Stay ahead of regulatory changes affecting your business</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Regulatory monitoring and alert system coming soon...</p>
        </CardContent>
      </Card>
    </div>
  );
