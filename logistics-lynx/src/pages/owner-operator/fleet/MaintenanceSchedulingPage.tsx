    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">YTD maintenance</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Plan and track all vehicle maintenance activities</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Maintenance scheduling tools coming soon...</p>
        </CardContent>
      </Card>
    </div>
  );
