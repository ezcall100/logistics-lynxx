...
import { Fuel, DollarSign, TrendingDown, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track fuel costs and optimize efficiency</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Best Stations</CardTitle>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Monitor costs, efficiency and optimize fuel purchasing</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Advanced fuel management tools coming soon...</p>
        </CardContent>
      </Card>
    </div>
  );
