    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Grow and expand your transportation business</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Business Goals</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Business Development Center</CardTitle>
          <CardDescription>Resources and tools for business growth</CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">Business development tools coming soon...</p>
        </CardContent>
      </Card>
    </div>
  );
