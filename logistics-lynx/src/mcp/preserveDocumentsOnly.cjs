// 📚 PRESERVE DOCUMENTS ONLY - NO PAGE REGENERATION
const fs = require('fs');
...
// Main function
async function preserveDocumentsOnly() {
  console.log('📚 PRESERVING DOCUMENTS ONLY - NO PAGE REGENERATION');
...
if (require.main === module) {
  preserveDocumentsOnly().catch(console.error);
}

module.exports = { preserveDocumentsOnly };
