...
const ShipperPortal = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: 'info', message: 'New shipment request', time: '2 min ago' },
    { id: 2, type: 'warning', message: 'Delivery delayed', time: '5 min ago' },
    { id: 3, type: 'success', message: 'Shipment delivered on time', time: '10 min ago' }
  ]);

  // Menu structure for Shipper Admin Dashboard
  const menuStructure = {
    dashboard: {
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-slate-900">Shipper Admin</h1>
                <p className="text-sm text-slate-600">Shipping & Logistics Management</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-md mx-8 hidden md:block">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-white/50 backdrop-blur-sm border-slate-200 focus:border-purple-500"
              />
            </div>
          </div>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-medium leading-none">Shipper Admin</p>
              ...
              <div key={key}>
                {menu.submenus.length === 0 ? (
                  <Button
                    ...
                    className={`w-full justify-start ${activeMenu === key ? 'bg-purple-500 text-white' : ''}`}
                  ...
                  <Collapsible>
                    <CollapsibleTrigger asChild>
                      <Button
                        variant={activeMenu === key ? "default" : "ghost"}
                        className={`w-full justify-between ${activeMenu === key ? 'bg-purple-500 text-white' : ''}`}
                        onClick={() => handleMenuClick(key)}
                      >
                        ...
                        {menu.submenus.map((submenu, index) => (
                          <Button
                            ...
                            className={`w-full justify-start text-sm ${
                              activeSubmenu === submenu.label ? 'bg-purple-100 text-purple-700' : ''
                            }`}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-slate-200/50">
                <h2 className="text-2xl font-semibold text-slate-900 mb-2">
                  Welcome back, Shipper Admin! 📦
                </h2>
                <p className="text-slate-600">
                  Manage your shipping operations and logistics efficiently.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50 hover:shadow-lg transition-all duration-300">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Carriers Used</CardTitle>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { action: 'New shipment request created', time: '2 minutes ago', type: 'request' },
                      { action: 'Carrier assigned to shipment', time: '1 hour ago', type: 'assignment' },
                      { action: 'Shipment picked up', time: '3 hours ago', type: 'pickup' },
                      { action: 'Shipment delivered successfully', time: '5 hours ago', type: 'delivery' }
                    ].map((activity, index) => (
