...
const CarrierPortal = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: 'info', message: 'New shipment assigned', time: '2 min ago' },
    { id: 2, type: 'warning', message: 'Fuel card expiring soon', time: '5 min ago' },
    { id: 3, type: 'success', message: 'Invoice paid successfully', time: '10 min ago' }
  ]);

  // Menu structure for Carrier Admin Dashboard
  const menuStructure = {
    dashboard: {
    ...
    loadBoard: {
      ...
      label: 'Load Board',
      submenus: [
        { label: 'Find Loads', icon: Search },
        { label: 'Search Loads', icon: Filter },
        { label: 'Post Truck', icon: Plus },
        { label: 'My Load', icon: Package }
      ]
    },
    networks: {
      icon: Network,
    ...
    assets: {
      ...
      label: 'Assets',
      submenus: [
        { label: 'Unit', icon: Truck },
        { label: 'Trucks', icon: Truck },
        { label: 'Trailers', icon: Package },
        { label: 'Fleet Tracker', icon: Route },
        { label: 'Compliance', icon: Shield },
        { label: 'Fuel Audit', icon: Fuel }
      ]
    },
    workers: {
      icon: Users,
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-slate-900">Carrier Admin</h1>
                <p className="text-sm text-slate-600">Transportation Management</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 max-w-md mx-8 hidden md:block">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-white/50 backdrop-blur-sm border-slate-200 focus:border-blue-500"
              />
            </div>
          </div>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                <DropdownMenuLabel className="font-normal">
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-medium leading-none">Carrier Admin</p>
              ...
              <div key={key}>
                {menu.submenus.length === 0 ? (
                  <Button
                    ...
                    className={`w-full justify-start ${activeMenu === key ? 'bg-blue-500 text-white' : ''}`}
                  ...
                  <Collapsible>
                    <CollapsibleTrigger asChild>
                      <Button
                        variant={activeMenu === key ? "default" : "ghost"}
                        className={`w-full justify-between ${activeMenu === key ? 'bg-blue-500 text-white' : ''}`}
                        onClick={() => handleMenuClick(key)}
                      >
                        ...
                        {menu.submenus.map((submenu, index) => (
                          <Button
                            ...
                            className={`w-full justify-start text-sm ${
                              activeSubmenu === submenu.label ? 'bg-blue-100 text-blue-700' : ''
                            }`}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-slate-200/50">
                <h2 className="text-2xl font-semibold text-slate-900 mb-2">
                  Welcome back, Carrier Admin! 🚛
                </h2>
                <p className="text-slate-600">
                  Manage your fleet, shipments, and operations efficiently.
                </p>
              </div>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50">
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { action: 'New shipment assigned', time: '2 minutes ago', type: 'shipment' },
                      { action: 'Truck maintenance completed', time: '1 hour ago', type: 'maintenance' },
                      { action: 'Invoice paid', time: '3 hours ago', type: 'payment' },
                      { action: 'Route optimized', time: '5 hours ago', type: 'route' }
                    ].map((activity, index) => (
