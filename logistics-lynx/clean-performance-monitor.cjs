...
console.log('🔧 Creating clean PerformanceMonitorDashboard.tsx...');
...
fs.writeFileSync('src/pages/super-admin/system-monitoring/PerformanceMonitorDashboard.tsx', cleanContent);

console.log('✅ Clean PerformanceMonitorDashboard.tsx created!');
