...
-- ==========================================
-- 4. ADD AUTONOMOUS AGENT TASKS FOR ERROR MONITORING
-- ==========================================
...
-- Add missing indexes for performance (without CONCURRENTLY)
...
CREATE INDEX IF NOT EXISTS idx_companies_dot_mc ON public.companies(dot_number, mc_number) WHERE dot_number IS NOT NULL OR mc_number IS NOT NULL;
